        ...
        <div class="col-lg-12">
            ...
            <table id="tableCustomer" class="table table-striped table-bordered table-dark">
                ...
                <tr>
                    ...
                    <th>ID Contract</th>
                    <th>ID Attrach Service</th>
                    <th>Quatily</th>
                    <th>Option Edit</th>
                    <th>Option Delete</th>
                </tr>
                </thead>
                <tbody><c:forEach var="detail" items="${list}">
                    <tr>
                        <td><c:out value="${detail.idDetail}"/></td>
                        <td><c:out value="${detail.idContract}"/></td>
                        <td><c:out value="${detail.idServiceAttach}"/></td>
                        <td><c:out value="${detail.quatily}"/></td>
                        <td><a href="?action=editContract&id=${detail.idDetail}" class="text-white">Edit</a></td>
                        <td><a class="btn btn-danger" href="#" onclick="customerSetId('${detail.idDetail}','${detail.idDetail}')"
...
<div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="?action=createContractDetail" method="post">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <table border="1" cellpadding="5">
                        ...
                        <tr>
                            <th>ID Contract:</th>
                            <td>
                                <input type="text" name="contract" id="name" size="45" required/>
                            </td>
                        </tr>
                        <tr>
                            <th>ID Attach Service:</th>
                            <td>
                                <input type="text" name="service" id="email" size="45" required/>
                            </td>
                        </tr>
                        <tr>
                            <th>Quatily:</th>
                            <td>
                                <input type="text" name="quatily" id="gender" size="15" required/>
                            </td>
                        </tr>
