package _16_IO_File.bai_tap.doc_file;
...
public class WriterAndRead {
    public static void Wirter(){
        try {
            FileWriter fileWriter = new FileWriter("src/_16_IO_File/bai_tap/doc_file/file.csv");
    ...
    public static void Read(){
        try {
            FileReader fileReader = new FileReader("src/_16_IO_File/bai_tap/doc_file/file.csv");
